...
.. toctree::
    :caption: 第五章 量子计算前言话题
    :maxdepth: 2

    rst/5.1利用QPanda测试量子系统噪声.rst
    rst/5.2量子机器学习.rst
    rst/5.3使用单振幅和部分振幅量子虚拟机.rst
    rst/5.4将量子程序编译到不同的量子芯片上.rst

.. toctree::
    :caption: 附录一 量子计算数学基础
    :maxdepth: 2

    rst/附录1量子计算数学基础1.rst
    rst/附录1量子计算数学基础2.rst
    rst/附录1量子计算数学基础3.rst
    rst/附录1量子计算数学基础4.rst
    rst/附录1量子计算数学基础5.rst

.. toctree::
    :caption: 附录二 量子编程工具安装与配置
    :maxdepth: 2

    rst/附录2量子编程工具的安装与配置.rst

.. toctree::
    :caption: 附录三 量子化学工具的安装与使用
    :maxdepth: 2

    rst/附录3量子化学工具的安装与使用.rst
